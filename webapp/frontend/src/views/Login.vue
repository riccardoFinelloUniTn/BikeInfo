<template>
    <div
        class="mt-40 md:w-1/2 w-4/5 mx-auto text-black bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-neutral-900 dark:border-neutral-700">
            ...
            <div class="mt-5">
                ...
                <form>
                    <div class="grid gap-y-4">
                        ...
                        <p class="hidden text-xs text-red-600 mt-2" id="login-error">{{ errorMsg }}</p>
                    </div>
                </form>
                <!-- End Form -->
            </div>
