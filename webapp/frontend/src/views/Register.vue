<template>
    <div
        class="md:mt-40 md:w-1/2 mt-28 w-4/5 mx-auto text-black bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-neutral-900 dark:border-neutral-700">
            ...
            <form>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="hidden text-xs text-red-600 mt-2" id="name-error">Please enter your name</p>
                    </div>
                    <div>
                        ...
                        <p class="hidden text-xs text-red-600 mt-2" id="surname-error">Please enter your surname</p>
                    </div>
                </div>
                <!-- End Form Group -->
                ...
                <p class="hidden text-xs text-red-600 mt-2" id="registration-error">{{ errorMsg }}</p>
            </form>
            <!-- End Form -->
            </div>
        </div>
        ...
        methods: {
            async register(){
                ...
                if (!(document.getElementById('remember-me') as HTMLInputElement).checked) {
                    ...
                    this.errorMsg = "You must accept the Terms and Conditions to register";
                    return;
                } else {
